...
ic1=new ImageIcon("circle.png");  
ic2=new ImageIcon("cross.png");  
ic11=new ImageIcon("us.png");  
ic22=new ImageIcon("it.png");  
...
for(i=0;i<=7;i++){  
  ...
  Icon icon3=b[(a[i][3]-1)].getIcon();  
    ...
    JOptionPane.showMessageDialog(TTT1.this,"!!!YOU won ALL the 4 games!!! ");    
   // new last();
